            ...
            while ((line = br.readLine()) != null) {
                ...
                if (modelData.get(displayRow[1]) != null) {
                    ...
                    if (modelLine != null) {
                        ...
                        modelMap.put(modelRow[0],surroundQuotes(modelRow[0]) + delimiter + surroundQuotes(modelRow[7]) + delimiter + path + delimiter + surroundQuotes("1") + delimiter + surroundQuotes(modelRow[19]) + delimiter + surroundQuotes(modelRow[26]) + delimiter + surroundQuotes(modelRow[10]) + delimiter + surroundQuotes("0x41900000") + delimiter + surroundQuotes("0x41400000") + delimiter + surroundQuotes("1") + delimiter + surroundQuotes("") + delimiter + surroundQuotes("0") + delimiter + surroundQuotes(modelRow[17]) + delimiter + surroundQuotes("0") + delimiter + surroundQuotes(modelRow[20]) + delimiter + surroundQuotes(modelRow[21]) + delimiter + surroundQuotes(modelRow[30]) + delimiter + surroundQuotes(modelRow[1]) + delimiter + surroundQuotes(modelRow[2]) + delimiter + surroundQuotes(modelRow[3]) + delimiter + surroundQuotes(modelRow[4]) + delimiter + surroundQuotes(modelRow[5]) + delimiter + surroundQuotes(modelRow[6]) + delimiter + surroundQuotes("1") + delimiter + surroundQuotes(modelRow[22]) + delimiter + surroundQuotes(modelRow[25]) + delimiter + surroundQuotes("0x0") + delimiter + surroundQuotes("0") + delimiter + "\n");
